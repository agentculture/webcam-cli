...
uv run webcam-cli whoami  # identity from culture.yaml
uv run webcam-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `webcam_cli/` and the `webcam-cli`
