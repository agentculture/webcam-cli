...
Every failure inside webcam-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`webcam_cli.cli._output`,
...
# Exit-code policy. Documented in ``webcam-cli learn`` output.
# 0      = success
